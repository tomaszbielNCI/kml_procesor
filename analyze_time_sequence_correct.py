...
print('=== CORRECT TIME SEQUENCE ANALYSIS ===')
            ...
            for j, point in enumerate(track_points[:20]):
                ...
                if extensions is not None:
                    ...
                    if track_ext is not None:
                        ...
                        clock_time = clock_elem.text if clock_elem is not None else 'N/A'
                        seconds = seconds_elem.text if seconds_elem is not None else 'N/A'
